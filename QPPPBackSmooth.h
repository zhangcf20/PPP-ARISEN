...
public:
    ...
    QPPPBackSmooth(QStringList files_path, QTextEdit *pQTextEdit = NULL, QString Method = "Kalman", QString Satsystem = "G",
              QString TropDelay = "Sass", double CutAngle = 10, bool isKinematic = false, QString Smooth_Str = "NoSmooth",
              QString products = "igs", QString pppmodel_t = "IF");
    ~QPPPBackSmooth();
    void initQPPPBackSmooth(QString OFileName, QStringList Sp3FileNames, QStringList ClkFileNames, QStringList ErpFileName,
...
// next public function is for GUI
    ...
    //2021.03.11 23z
    void SSDPPP(bool isDisplayEveryEpoch = true);
    void PPPAR(bool isDisplayEveryEpoch = true);
