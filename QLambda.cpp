...
//Z transform 2020.12.06 23z
void QLambda::calculateZ(MatrixXd Q_part, MatrixXd &Q_Z)
{
   int n = Q_part.rows(), cf = 0;
   double *L = NULL, *D = NULL, *Q = NULL, *Zcf = NULL;
   L = zeros(n,n);
   D = mat(n,1);
   Q = (double *)malloc(sizeof(double) *n * n);
   Zcf = eye(n);
